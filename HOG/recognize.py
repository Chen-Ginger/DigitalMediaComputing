...
# 训练集图片的位置
train_image_path = 'img_changed'
# 测试集图片的位置
test_image_path = 'img_test_changed'

# 训练集标签的位置
train_label_path = os.path.join('img_changed','train.txt')
# 测试集标签的位置
test_label_path = os.path.join('img_test_changed','test.txt')
